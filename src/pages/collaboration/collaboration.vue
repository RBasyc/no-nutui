    ...
    <view class="collaboration-page">
        ...
        <view class="experiment-plan-section">
            ...
            <view v-if="experimentPlans.length > 0" class="plan-list">
                <view v-for="plan in experimentPlans.slice(0, 2)" :key="plan.id" class="plan-card"
                    ...
                    <view class="plan-items">
                        ...
                        <view class="items-list">
                            <text v-for="(item, index) in plan.itemsNeeded.slice(0, 2)" :key="index" class="item-tag"
                                :class="item.status">
        ...
        <view class="consumable-sharing-section">
            ...
            <view v-if="currentTab === 'requests'" class="request-section">
                ...
                <view class="request-type-tabs">
                    <view v-for="type in requestTypes" :key="type.value" class="type-tab-item"
                ...
                <view class="search-bar">
                    <view class="search-input-wrapper">
                        ...
                        <input v-model="searchKeyword" placeholder="搜索耗材名称、标题..." class="search-input"
                ...
                <view class="request-list">
                    <view v-for="item in requestList" :key="item.id" class="request-card" :class="[item.status]"
                        @tap="handleRequestClick(item)">
                        <!-- 卡片头部 -->
                        <view class="card-header">
                            <view class="user-info">
                                <view class="user-avatar">
                                    <image v-if="item.avatar && item.avatar.startsWith('http')" :src="item.avatar"
            ...
            <view v-if="currentTab === 'my-share'" class="my-share-list">
                ...
                <view v-for="item in myShareList" :key="item.id" class="share-item-card">
